...
Live.banner!("15_upload_small_text_file.exs")

client = Live.client!()
filename = "notion_sdk_example_upload.txt"
contents = "notion_sdk example upload at #{DateTime.utc_now() |> DateTime.to_iso8601()}\n"

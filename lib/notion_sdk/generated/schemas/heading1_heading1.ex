defmodule NotionSDK.Heading1Heading1 do
  @moduledoc """
  Generated Notion Sdk type for heading1 heading1.
  """
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.Heading1Heading1, type, data)
  end
end

defmodule NotionSDK.ToDoToDo do
  @moduledoc """
  Generated Notion Sdk type for to do to do.
  """

  @enforce_keys [:rich_text]
  defstruct [:checked, :children, :color, :rich_text]
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.ToDoToDo, type, data)
  end
end

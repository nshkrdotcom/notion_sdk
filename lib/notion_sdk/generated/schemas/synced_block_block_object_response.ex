defmodule NotionSDK.SyncedBlockBlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type module `NotionSDK.SyncedBlockBlockObjectResponse`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          synced_block: NotionSDK.SyncedBlockBlockObjectResponseSyncedBlock.t(),
          type: String.t()
        }
  @doc false
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.SyncedBlockBlockObjectResponseSyncedBlock, :t},
        write_only: false
      },
      %{
        default: nil,

defmodule NotionSDK.CodeBlockObjectResponseCode do
  @moduledoc """
  Generated Notion Sdk type for code block object response code.
  """

  @enforce_keys [:caption, :language, :rich_text]
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.CodeBlockObjectResponseCode, type, data)
  end
end

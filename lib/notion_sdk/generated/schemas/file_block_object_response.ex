defmodule NotionSDK.FileBlockObjectResponse do
  ...
  @type t :: %__MODULE__{
          ...
          file:
            NotionSDK.ExternalMediaContentWithFileNameAndCaptionResponse.t()
            | NotionSDK.FileMediaContentWithFileNameAndCaptionResponse.t(),
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.FileBlockObjectResponse, type, data)
  end
end

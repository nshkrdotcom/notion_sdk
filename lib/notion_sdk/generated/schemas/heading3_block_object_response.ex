defmodule NotionSDK.Heading3BlockObjectResponse do
  ...
  @type t :: %__MODULE__{
          ...
          heading_3: NotionSDK.HeaderContentWithRichTextAndColorResponse.t(),
          id: String.t(),
          in_trash: boolean(),
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.Heading3BlockObjectResponse, type, data)
  end
end

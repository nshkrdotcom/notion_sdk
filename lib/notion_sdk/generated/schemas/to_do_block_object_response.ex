defmodule NotionSDK.ToDoBlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for to do block object response.
  """
  ...
  @type t :: %__MODULE__{
          ...
          to_do: NotionSDK.ToDoBlockObjectResponseToDo.t(),
          type: String.t()
        }
  @doc false
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.ToDoBlockObjectResponseToDo, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.ToDoBlockObjectResponse, type, data)
  end
end

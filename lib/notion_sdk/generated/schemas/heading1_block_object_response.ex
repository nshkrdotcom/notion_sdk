defmodule NotionSDK.Heading1BlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for heading1 block object response.
  """
  ...
  @type t :: %__MODULE__{
          ...
          heading_1: NotionSDK.HeaderContentWithRichTextAndColorResponse.t(),
          id: String.t(),
          in_trash: boolean(),
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.Heading1BlockObjectResponse, type, data)
  end
end

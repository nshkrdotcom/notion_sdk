defmodule NotionSDK.Heading1 do
  @moduledoc """
  Generated Notion Sdk type for heading1.
  """

  @enforce_keys [:heading_1]
  ...
  def __openapi_fields__(:t_heading_1) do
    [
      %{
        default: nil,
        deprecated: false,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.Heading1, type, data)
  end
end

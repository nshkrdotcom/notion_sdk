defmodule NotionSDK.LinkPreviewBlockObjectResponse do
  ...
  @type t :: %__MODULE__{
          ...
          link_preview: NotionSDK.MediaContentWithUrlResponse.t(),
          object: String.t(),
          parent:
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.MediaContentWithUrlResponse, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(
      NotionSDK.LinkPreviewBlockObjectResponse,
      type,
      data
    )
  end

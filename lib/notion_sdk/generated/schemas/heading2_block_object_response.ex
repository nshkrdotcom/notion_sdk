defmodule NotionSDK.Heading2BlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for heading2 block object response.
  """
  ...
  @type t :: %__MODULE__{
          ...
          heading_2: NotionSDK.HeaderContentWithRichTextAndColorResponse.t(),
          id: String.t(),
          in_trash: boolean(),
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.HeaderContentWithRichTextAndColorResponse, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.Heading2BlockObjectResponse, type, data)
  end
end

defmodule NotionSDK.BulletedListItem do
  @moduledoc """
  Provides struct and types for BulletedListItem
  ...
  def __schema__(:t_bulleted_list_item) do
    OpenAPIRuntime.build_schema(__openapi_fields__(:t_bulleted_list_item))
  end

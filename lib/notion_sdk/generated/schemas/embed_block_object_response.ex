defmodule NotionSDK.EmbedBlockObjectResponse do
  ...
  @type t :: %__MODULE__{
          ...
          embed: NotionSDK.MediaContentWithUrlAndCaptionResponse.t(),
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.MediaContentWithUrlAndCaptionResponse, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.EmbedBlockObjectResponse, type, data)
  end
end

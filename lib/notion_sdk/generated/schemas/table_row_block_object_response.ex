defmodule NotionSDK.TableRowBlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for table row block object response.
  """
  ...
  @type t :: %__MODULE__{
          ...
          table_row: NotionSDK.ContentWithTableRowResponse.t(),
          type: String.t()
        }
  @doc false
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.ContentWithTableRowResponse, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.TableRowBlockObjectResponse, type, data)
  end
end

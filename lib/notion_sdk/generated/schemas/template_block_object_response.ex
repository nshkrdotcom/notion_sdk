defmodule NotionSDK.TemplateBlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for template block object response.
  """
  ...
  @type t :: %__MODULE__{
          ...
          template: NotionSDK.TemplateBlockObjectResponseTemplate.t(),
          type: String.t()
        }
  @doc false
  ...
  def __openapi_fields__(:t) do
    [
      ...
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.TemplateBlockObjectResponseTemplate, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.TemplateBlockObjectResponse, type, data)
  end
end

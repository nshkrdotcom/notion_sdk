defmodule NotionSDK.ColumnBlockObjectResponse do
  @moduledoc """
  Generated Notion Sdk type for column block object response.
  """
  ...
  def __openapi_fields__(:t) do
    [
      %{
        ...
        read_only: false,
        required: true,
        type: {NotionSDK.ColumnResponse, :t},
        write_only: false
      },
      %{
        default: nil,
  ...
  def decode(data, type) when is_map(data) and is_atom(type) do
    Pristine.Runtime.Schema.decode_module_type(NotionSDK.ColumnBlockObjectResponse, type, data)
  end
end
